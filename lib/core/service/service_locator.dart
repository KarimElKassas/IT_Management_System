...
class ServiceLocator {
  void setup() {
    ...
    sl.registerFactory(() => NewComputerCubit(sl(), sl(),sl(),sl(), sl(),sl(),sl(),sl(),sl(),sl(),sl(),sl()));
    sl.registerFactory(() => NewLaptopCubit(sl(), sl(),sl(),sl(), sl(),sl(),sl(),sl(),sl(),sl(),sl(),sl()));
    ...
    sl.registerLazySingleton<GetProcessorBrandsUseCase>(() => GetProcessorBrandsUseCase(sl()));
    sl.registerLazySingleton<GetProcessorModelsUseCase>(() => GetProcessorModelsUseCase(sl()));
    sl.registerLazySingleton<GetProcessorGensUseCase>(() => GetProcessorGensUseCase(sl()));
    sl.registerLazySingleton<GetGraphicBrandsUseCase>(() => GetGraphicBrandsUseCase(sl()));
    sl.registerLazySingleton<GetGraphicModelsUseCase>(() => GetGraphicModelsUseCase(sl()));
    sl.registerLazySingleton<GetRamTypesUseCase>(() => GetRamTypesUseCase(sl()));
    sl.registerLazySingleton<GetHardTypesUseCase>(() => GetHardTypesUseCase(sl()));
    sl.registerLazySingleton<GetPcModelUseCase>(() => GetPcModelUseCase(sl()));
    sl.registerLazySingleton<GetScreenBrandsUseCase>(() => GetScreenBrandsUseCase(sl()));
