...
class RemoteDataSource implements BaseRemoteDataSource {
  ...
  Future<String> loginUser(LoginUserParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.authenticate, data: parameters.data);
  ...
  Future<List<DepartmentModel>> getDepartments(
    ...
    return List<DepartmentModel>.from((response.data['data'] as List).map((e) =>
  ...
  Future<List<SectorModel>> getSectors(GetSectorsParameters parameters) async {
    ...
    print("DATA MAP : ${response.data}");
    return List<SectorModel>.from(
        (response.data['data'] as List).map((e) => SectorModel.fromJson(e)));
  }
  ...
  Future<List<GraphicsCardBrandModel>> getGraphicBrands(parameters) async {
    ...
    print("DATA MAP : ${response.data}");
    return List<GraphicsCardBrandModel>.from(
        (response.data['data'] as List).map((e) =>
            GraphicsCardBrandModel.fromJson(e)));
  }

  @override
  Future<List<GraphicsCardModelDeviceModel>> getGraphicModels(
      parameters) async {
    final response = await DioHelper.getData(
    ...
    print("DATA MAP : ${response.data}");
    return List<GraphicsCardModelDeviceModel>.from(
        (response.data['data'] as List).map((e) =>
            GraphicsCardModelDeviceModel.fromJson(e)));
  }
  ...
  Future<List<ProcessorBrandModel>> getProcessorBrands(parameters) async {
    ...
    print("DATA MAP : ${response.data}");
    return List<ProcessorBrandModel>.from(
        (response.data['data'] as List).map((e) =>
            ProcessorBrandModel.fromJson(e)));
  }
  ...
  Future<List<ProcessorCoreGenModel>> getProcessorGens(parameters) async {
    ...
    print("DATA MAP : ${response.data}");
    return List<ProcessorCoreGenModel>.from(
        (response.data['data'] as List).map((e) =>
            ProcessorCoreGenModel.fromJson(e)));
  }
  ...
  Future<List<ProcessorModelDeviceModel>> getProcessorModels(parameters) async {
    ...
    print("DATA MAP : ${response.data}");
    return List<ProcessorModelDeviceModel>.from(
        (response.data['data'] as List).map((e) =>
            ProcessorModelDeviceModel.fromJson(e)));
  }

  @override
  Future<List<HardDriveTypeModel>> getHardTypes(
    ...
    print("DATA MAP : ${response.data}");
    return List<HardDriveTypeModel>.from(
        (response.data['data'] as List).map((e) =>
            HardDriveTypeModel.fromJson(e)));
  }

  @override
  Future<List<RamTypeModel>> getRamTypes(
    ...
    print("DATA MAP : ${response.data}");
    return List<RamTypeModel>.from(
        (response.data['data'] as List).map((e) => RamTypeModel.fromJson(e)));
  }

  @override
  Future<List<PcModelDeviceModel>> getPcModel(
    ...
    print("DATA MAP : ${response.data}");
    return List<PcModelDeviceModel>.from(
        (response.data['data'] as List).map((e) =>
            PcModelDeviceModel.fromJson(e)));
  }

  @override
  Future<String> addDevice(AddDeviceParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createDevice, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  Future<String> addScreen(AddScreenParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createScreen, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  @override
  Future<List<ScreenBrandModel>> getScreenBrands(
    ...
    print("DATA MAP : ${response.data}");
    return List<ScreenBrandModel>.from(
        (response.data['data'] as List).map((e) =>
            ScreenBrandModel.fromJson(e)));
  }

  @override
  Future<String> addSector(AddSectorParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createSector, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  Future<String> addArea(AddAreaParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createArea, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  Future<String> addDepartment(AddDepartmentParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createDepartment, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  @override
  Future<String> addProcessorBrand(
      AddProcessorBrandParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createProcessorBrand, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  @override
  Future<String> addProcessorModel(
      AddProcessorModelParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createProcessorCore, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  Future<String> addProcessorGen(AddProcessorGenParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createProcessorGen, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  @override
  Future<String> addGraphicCardBrand(
      AddGraphicCardBrandParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createGraphicBrand, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  @override
  Future<String> addGraphicCardModel(
      AddGraphicCardModelParameters parameters) async {
    final response = await DioHelper.postData(
        url: 'http://172.16.1.75:9001/AddGraphicsCardModel',
  ...
  @override
  Future<String> addRamType(AddRamTypeParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createRamType, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  Future<String> addDeviceModel(AddDeviceModelParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createPcModel, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
  ...
  @override
  Future<String> addHardType(AddHardTypeParameters parameters) async {
    final response = await DioHelper.postData(
        url: EndPoints.createHardType, data: parameters.data,
        options: Options(headers: {
          'Authorization': 'Bearer ${parameters.token}',
          'Content-Type': 'application/json; charset=utf-8'
        }));
